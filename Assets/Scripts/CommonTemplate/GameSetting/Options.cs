...
namespace CommonTemplate.GameSetting
{
    ...
    {
        private Dictionary<string, OptionsValue> _values = new Dictionary<string, OptionsValue>(64);
        private Dictionary<string, OptionsValue> _dirtyValues = new Dictionary<string, OptionsValue>(64);
        ...
        public bool HasUnsavedChanges => _dirtyValues.Count > 0;
        public string PersistencyPrefix => _persistencyPrefix;
        ...
        {
            var values = _optionsData.AllValues;
        ...
        {
            if (value.Type == EOptionsValueType.None || string.IsNullOrEmpty(value.Key))
            {
